...
working through the code. Every time a class object is instantiated, when we declare a variable, a new object is initiated from scratch
Whereas in Python, Modules are simply files with the . py extension containing Python code that can be imported inside another Python Program. In simple terms,
...
Example: umesh = iNeuron('FSDS',15000), Here umesh is an instance of class iNeuron with attriubutes 'FSDS' and 15000.
Whereas for creating a class, we use the Class keyword. Class keyword is followed by classname and semicolon.
Example: Here iNeuron is a class created with class keyword with arguments course and fee.
class iNeuron:
...
instead each object maintains its own copy of instance attributes at object level. whereas in case of class attributes all instances of class refer to a single copy.
...
Sum -> 3
String Concatenation -> UmeshGanesh

# Q9. What are the two most important concepts to grasp in order to comprehend Python OOP code?
Ans: Classes and objects are the two concepts to comprehend python OOP code as more formally objects are entities that represent instances of general abstract concept
called class
