...
Ans: Object-oriented programming is a programming paradigm that provides a means of structuring programs so that properties and
...
Example: my_name = my_class("umesh","ganesh") Here my_name is an instance of class my_class with attributes "umesh" and "ganesh".
...
Example: class SBI(RBI): Here child class SBI inherits attributes and methods from Superclass/Parent RBI
